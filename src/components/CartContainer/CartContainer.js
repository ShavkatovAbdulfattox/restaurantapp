      ...
      <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
        ...
        <div className="w-full h-340 md:h-420 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-none">
          ...
          <div className="w-full p-1 px-2 rounded-lg bg-cartItem flex items-center gap-2">
            <img
              src="https://firebasestorage.googleapis.com/v0/b/restaurantapp-6bc60.appspot.com/o/Images%2F1684732404862-f7.png?alt=media&token=d86b02fb-0cae-46b5-a283-8c726908fcb2"
              alt=""
              className="w-20 h-20 max-w-[60px] rounded-full object-contain"
            />

            <div className="flex flex-col gap-2">
              <p className="text-base text-gray-50">Vanilla Ch</p>
